...
import {Swiper, SwiperSlide, SwiperSlot} from 'swiper/react'
import 'swiper/css'
import 'swiper/css/pagination'
// import patientAvatar from '../../assets/images/patient-avatar.img'
        ...
        <SwiperSlide>
            <div className='py-[30px] px-5 rounded-3'>
                <div className='flex items-center gap-[13px] '>
                    ...
                    <div>
                        <h4 className='text-[18px] leading-[30px] font-semibold text-geadingColor'> Muhibur Rahman</h4>
